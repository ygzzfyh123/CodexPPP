...
export const EN_PLAIN: Record<string, string> = {
  ...
  "请在浏览器中完成登录，管理器会自动接收结果。":
    "Complete sign-in in the browser. The manager will receive the result automatically.",
  "手机配对": "Phone pairing",
  "设备撤销": "Device revocation",
  "配对码已过期，请重新生成。": "The pairing code expired. Generate a new one.",
  "手机已完成配对。": "The phone has been paired.",
  ...
  "尚未创建远控主机": "Remote host not created",
  "安装标识": "Installation ID",
  "环境标识": "Environment ID",
  "关闭远控": "Disable remote control",
  "启用远控": "Enable remote control",
  "刷新状态": "Refresh status",
  "在手机 ChatGPT 应用中输入短时配对码": "Enter the short-lived pairing code in the ChatGPT mobile app",
  "手动配对码": "Manual pairing code",
  "复制配对码": "Copy pairing code",
  "可以生成新的手机配对码": "A new phone pairing code can be generated",
  "启用远控后可生成配对码": "Enable remote control to generate a pairing code",
  "生成配对码": "Generate pairing code",
  "已连接设备": "Connected devices",
  "撤销设备": "Revoke device",
  "尚无已连接设备。": "No connected devices yet.",
  "连接 ChatGPT 账号并管理官方手机远控": "Connect a ChatGPT account and manage official mobile remote control",
  "已连接": "Connected",
  "正在连接": "Connecting",
  "连接异常": "Connection error",
  "已关闭": "Disabled",
  "未命名设备": "Unnamed device",
  "暂无设备详情": "No device details",
...
export const EN_BACKEND: Record<string, string> = {
  ...
  "当前没有等待取消的 ChatGPT 登录。": "There is no ChatGPT sign-in waiting to be cancelled.",
  "ChatGPT 登录已取消，原配置已恢复。": "ChatGPT sign-in cancelled and the previous configuration restored.",
  "官方手机远控状态已刷新。": "Official mobile remote-control status refreshed.",
  "官方手机远控已启用。": "Official mobile remote control enabled.",
  "官方手机远控已关闭。": "Official mobile remote control disabled.",
  "手机配对码已生成。": "Phone pairing code generated.",
  "手机配对状态已刷新。": "Phone pairing status refreshed.",
  "已撤销所选手机设备。": "The selected phone device was revoked.",
...
export const EN_BACKEND_PATTERNS: Array<[RegExp, string]> = [
  ...
  [/^生成手机配对码失败：(.+)$/, "Failed to generate phone pairing code: $1"],
  [/^读取手机配对状态失败：(.+)$/, "Failed to read phone pairing status: $1"],
  [/^撤销手机设备失败：(.+)$/, "Failed to revoke phone device: $1"],
